...
INSERT INTO `files` VALUES (1,'test2.xlsx','D:/camProject/','c92923536c7d77c4aa8c72e1af32eb9be3632fc9a4cc5fe989ed035a54b20b63','CIRD9F','其他','student3','2021-08-18 00:00:00'),(2,'大学生网球运动体能训练方法探析_刘颖平.pdf','D:/camFiles/CIRD9F/','3fdc2c6d34612669fbdd6cb87770f8491ac833aea6e7e359609ccc8941c86f16','CIRD9F','其他','student3','2021-08-25 12:44:40');
...
INSERT INTO `notice` VALUES (1,'这是一个公告的标题','欢迎来到新班级，这是本班级的公告处。','CIRD9F','2021-07-25 13:27:37','teacher1',NULL,NULL,1,0),(2,'这是第二个公告的标题','好康，是新公告哦？','CIRD9F','2021-08-05 01:39:58','teacher1',NULL,NULL,1,0),(3,'这是第3个公告的标题','我看你，是完全不懂哦？','CIRD9F','2021-08-05 01:49:12','teacher1',NULL,NULL,1,0),(4,'这是第4个公告的标题','同学们注意！我要变形了！','CIRD9F','2021-08-05 01:57:50','teacher1',NULL,NULL,1,0),(5,'这是第1个公告的标题','欢迎来到新班级，这是本班级的公告处。','25VEO4','2021-08-05 01:59:54','teacher1',NULL,NULL,1,0),(6,'本公告旨在测试缓存能否清空','清空所有已缓存的页面','CIRD9F','2021-08-10 00:57:01','teacher1',NULL,NULL,1,0),(7,'本公告旨在测试缓存能否清空','清空所有已缓存的页面','CIRD9F','2021-08-12 16:46:58','teacher1','2021-08-12 16:46:00',NULL,1,0),(8,'这条部分人不可见','部分人不可见','CIRD9F','2021-08-21 00:09:19','teacher1',NULL,'其他',0,0),(9,'这条部分人不可见','部分人不可见','CIRD9F','2021-08-21 20:01:12','teacher1',NULL,'其他',0,0),(10,'本公告：11111','我是内容1111','CIRD9F','2021-08-25 11:35:05','teacher1','2021-08-27 16:46:00',NULL,0,0),(11,'本公告：11111','我是内容1111','CIRD9F','2021-08-25 11:37:26','teacher1','2021-08-27 16:46:00',NULL,0,0),(12,'本公告：11111','我是内容1111','CIRD9F','2021-08-25 11:37:47','teacher1','2021-08-27 16:46:00',NULL,1,0),(13,'本公告：22222','我是内容1111','CIRD9F','2021-08-26 21:59:14','teacher1','2021-08-27 16:46:00',NULL,1,1),(14,'本公告：22222','我是内容1111','CIRD9F','2021-08-26 22:54:11','teacher1','2021-08-27 16:46:00',NULL,1,1);
...
LOCK TABLES `notice_confirmers` WRITE;
...
LOCK TABLES `notice_permission` WRITE;
/*!40000 ALTER TABLE `notice_permission` DISABLE KEYS */;
INSERT INTO `notice_permission` VALUES (1,'student3'),(8,'student2'),(8,'student3'),(9,'student2'),(9,'student3');
...
INSERT INTO `signin` VALUES (1,'默认签到','1593','CIRD9F',NULL,NULL,'2021-08-16 11:32:27','normal','2021-08-25 19:14:51','teacher1'),(2,'默认签到66621','66621','CIRD9F',NULL,NULL,'2021-08-27 16:58:17','key','2021-08-27 16:55:12','teacher1');
...
LOCK TABLES `signin_signed` WRITE;
...
LOCK TABLES `stu_points_detail` WRITE;
/*!40000 ALTER TABLE `stu_points_detail` DISABLE KEYS */;
INSERT INTO `stu_points_detail` VALUES (2,'CIRD9F','teacher1','student3',1,'测试加分','2021-08-19 20:28:30'),(3,'CIRD9F','teacher1','student3',1,'课堂加分','2021-08-21 20:06:29'),(4,'CIRD9F','teacher1','student3',1,'测试加分(AOP)','2021-08-24 00:44:56'),(5,'CIRD9F','teacher1','student3',1,'测试加分(AOP)','2021-08-24 00:51:35'),(6,'CIRD9F','teacher1','student3',-1,'测试扣分(AOP)','2021-08-24 00:52:34');
...
LOCK TABLES `stu_selection` WRITE;
/*!40000 ALTER TABLE `stu_selection` DISABLE KEYS */;
INSERT INTO `stu_selection` VALUES ('student1','CIRD9F',0),('student2','CIRD9F',0),('student3','25VEO4',0),('student3','CIRD9F',0);
...
INSERT INTO `student_points` VALUES ('student1','CIRD9F',1),('student2','CIRD9F',2),('student3','CIRD9F',6),('teacher1','CIRD9F',100);
...
CREATE TABLE `teaching_class` (
  ...
  `schedule` varchar(30) NOT NULL COMMENT '周几第几节上课',
...
INSERT INTO `teaching_class` VALUES ('测试用班级2','周二 3-4节','teacher1','测试用学院','25VEO4'),('测试用班级','周一 9-11节','teacher1','测试用学院','CIRD9F');
...
CREATE TABLE `user` (
  ...
  `mobileNumber` varchar(11) CHARACTER SET utf8 NOT NULL DEFAULT '0',
...
INSERT INTO `user` VALUES ('Jessie','$2a$10$y8ppQ.ooPaE8lEFTvFDGaO0rcwu9Yr9ijCf/m4BQ5mBovMAR23YoG',1,NULL,'ljn',10,'admin',NULL,2,''),('student1','$2a$10$lSZcOhM3gQigNA1PRLWXT.iw9Er6vHR4dHzOJk7FedyB1QXvrsIQG',4,NULL,'s1',10,'student',NULL,2,''),('student2','$2a$10$usKIdDeHt1MxW.Wj0OSb8us6bsuCBWfcjCiIXGA9SSQrEG2IeFA1a',5,NULL,'s2',10,'student',NULL,2,''),('student3','$2a$10$mfZsHDgygKo83HXYMqdqpe8nZqgM1aKBcfSCu2zsgvow4X0aSi.M6',6,NULL,'s3',10,'student',NULL,2,''),('teacher1','$2a$10$izYs63Q96NYItVbEE2sEdOcotR/Q1Ev3erK9P6UOtS2L/HI/8juHG',3,NULL,'t1',10,'teacher',NULL,2,''),('user1','$2a$10$zGD5vvVACOicz4tDjW58Oe3apOEVNa9z8LWkjcaPCDhWidXXaX7ua',2,NULL,'u1',10,'student',NULL,2,'');
...
INSERT INTO `user_permission` VALUES ('Jessie','admin'),('student1','student'),('student1','student_CIRD9F'),('student1','teacher_CIRD9F'),('student2','student'),('student2','student_CIRD9F'),('student3','student'),('student3','student_25VEO4'),('student3','student_CIRD9F'),('teacher1','teacher'),('teacher1','teacher_25VEO4'),('teacher1','teacher_CIRD9F'),('user1','stu_0');
...
INSERT INTO `user_wechat` VALUES ('Jessie','oUqup56c23bBkqGBcCLOvbkneM80','admin');
...
INSERT INTO `vote` VALUES (1,'CIRD9F','这是一个投票的标题（需要持久化）',2,'2021-08-10 16:57:44',0,'teacher1','2021-08-27 15:06:24'),(2,'CIRD9F','快来投票',2,'2021-08-13 20:55:18',0,'teacher1','2021-08-27 15:06:24'),(3,'CIRD9F','快来投票吧',2,'2021-08-13 20:57:25',0,'teacher1','2021-08-27 15:06:24'),(4,'CIRD9F','快来投票吧',2,'2021-08-13 20:58:01',0,'teacher1','2021-08-27 15:06:24'),(5,'CIRD9F','快来投票吧',2,'2021-08-13 21:06:20',0,'teacher1','2021-08-27 15:06:24'),(6,'CIRD9F','快来投票吧',2,'2021-08-13 21:27:56',0,'teacher1','2021-08-27 15:06:24'),(7,'CIRD9F','持久化投票1',2,'2021-08-15 23:52:02',0,'teacher1','2021-08-27 15:06:24'),(8,'CIRD9F','新的投票100',2,'2021-08-26 22:04:45',0,'teacher1','2021-08-27 15:06:24'),(9,'CIRD9F','持久化投票100',2,'2021-08-26 22:05:31',0,'teacher1','2021-08-27 15:06:24');
